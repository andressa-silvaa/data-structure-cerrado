...
public class PerformanceBubbleSort extends BaseFrame implements AutoCloseable{
    ...
    //construtor da classe PerformanceHeapSort. Ele configura a imagem de fundo
    public PerformanceBubbleSort() throws IOException {
